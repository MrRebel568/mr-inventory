...
local function OpenInventory(name, id, other, origin)
	...
	if name and id then
		...
		TriggerClientEvent("mr-inventory:client:closeinv", id)
...
--	print('inventory:server:OpenInventory is deprecated use exports[\'mr-inventory\']:OpenInventory() instead.')
	local src = source
	local ply = Player(src)
	local Player = QBCore.Functions.GetPlayer(src)
	if ply.state.inv_busy then
...
RegisterNetEvent('inventory:server:addTrunkItems', function()
	print('inventory:server:addTrunkItems has been deprecated please use exports[\'mr-inventory\']:addTrunkItems(plate, items)')
end)
RegisterNetEvent('inventory:server:addGloveboxItems', function()
	print('inventory:server:addGloveboxItems has been deprecated please use exports[\'mr-inventory\']:addGloveboxItems(plate, items)')
end)
--#endregion Events

--#region Callbacks

QBCore.Functions.CreateCallback('mr-inventory:server:GetStashItems', function(_, cb, stashId)
